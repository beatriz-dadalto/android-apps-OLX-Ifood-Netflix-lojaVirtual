...
public class AdapterMinhaLista extends RecyclerView.Adapter<AdapterMinhaLista.MyViewHolder> {

    private List<Post> postList;
    private final OnClickListener clickListener;

    public AdapterMinhaLista(List<Post> postList, OnClickListener clickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_listagem_minha_lista, parent, false);
